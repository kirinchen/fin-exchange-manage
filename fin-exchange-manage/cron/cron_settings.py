...
def start_all():
    ...
    scheduler.add_job(func=lend_funding_job.cancel_current_books(), trigger="interval", seconds=3 * 60 * 60)
    scheduler.add_job(func=lend_funding_job_tom.cancel_current_books(), trigger="interval", seconds=3 * 60 * 60)
