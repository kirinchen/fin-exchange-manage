...
def start_all():
    ...
    scheduler.add_job(func=lend_funding_job.lend_and_cancel, trigger="interval", seconds=3 * 60 * 60)
    scheduler.add_job(func=lend_funding_job_tom.lend_and_cancel, trigger="interval", seconds=3 * 60 * 60)
